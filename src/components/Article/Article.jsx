    ...
    <div className="p-5 bg-gray-200 dark:bg-dark-200 sm:rounded-xl sm:shadow-xl sm:dark:shadow-gray-900 sm:dark:hover:shadow-gray-800 sm:hover:shadow-2xl flex flex-col items-center gap-2">
      ...
      <div className="w-full pr-5 flex gap-2 justify-end">
        {tags.map((tag) => (
          <span
            key={tag}
            className="px-4 py-1 bg-alura-100 sm:hover:scale-110 hover:bg-alura-200 dark:bg-dark-100 rounded-full text-gray-200 text-xs font-bold uppercase hover-scale-110 hover:bg-gradient-to-r hover:from-alura-200"
          >
            {tag}
          </span>
        ))}
